...
const Header = () => {
    ...
    return (
        <header
            className="sticky bg-gray-100 border-b border-gray-200 shadow-[0_4px_14px_rgba(0,0,0,0.08)] top-0 w-full z-40">
            <div className="relative z-20 bg-gray-100 max-w-5xl mx-auto px-3 py-3">
                <div className="flex items-center justify-between">
                    <Link
                        className="rounded-md text-gray-950 font-semibold tracking-tight cursor-pointer"
                        href="/"
                    >
                        Developer Showcase
                    </Link>
                    ...
                    <button className="cursor-pointer md:hidden text-gray-900 focus:outline-none" onClick={toggle}>
                        <svg
