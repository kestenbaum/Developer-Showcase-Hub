            ...
            <Container>
                <div className="flex justify-between">
                    <div className="flex flex-col gap-2.5 max-w-[750px]">
                        ...
                        <p className="text-white text-[10px] font-medium">A Frontend focused Web Developer building the Frontend of Websites and Web Applications that leads to the success of the overall product.</p>
                    </div>
